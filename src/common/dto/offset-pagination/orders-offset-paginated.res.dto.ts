...
export class OrdersOffsetPaginatedResDto extends OffsetPaginatedDto<any> {
  @NumberField()
  totalOrders: number;
  ...
  constructor(data: any[], meta: OffsetPaginationDto, totalOrders?: TOTAL_ORDERS_FOR_PAGINATED) {
    super(data, meta);
