...
CREATE TABLE "orders" (
	...
	"delivery_income_tax" numeric(15, 3) DEFAULT 0 NOT NULL,
	"total_product_tax" numeric(15, 3) DEFAULT 0 NOT NULL,
	"is_night" boolean DEFAULT false NOT NULL,
	"is_rain" boolean DEFAULT false NOT NULL,
	"night_fee" numeric(15, 3) DEFAULT 0 NOT NULL,
	"rain_fee" numeric(15, 2) DEFAULT 0 NOT NULL,
	...
	"payfor_shop" numeric(15, 3) DEFAULT 0 NOT NULL,
...
CREATE TABLE "settings" (
	...
	"start_night_time" timestamp DEFAULT '2025-07-07 15:04:53.205' NOT NULL,
	"end_night_time" timestamp DEFAULT '2025-07-07 15:04:53.205' NOT NULL,
...
CREATE INDEX "store_menus_deleted_at_idx" ON "store_menus" USING btree ("deleted_at");--> statement-breakpoint
