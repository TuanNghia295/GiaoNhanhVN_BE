ALTER TABLE "settings" ALTER COLUMN "start_night_time" SET DEFAULT '2025-06-30 08:22:22.392';--> statement-breakpoint
ALTER TABLE "settings" ALTER COLUMN "end_night_time" SET DEFAULT '2025-06-30 08:22:22.392';--> statement-breakpoint
ALTER TABLE "stores"
